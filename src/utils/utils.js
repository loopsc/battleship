 ...
 * @param {String} ship A type of ship. Example: "submarine"
 * @param {String} orientation Orientation. Example: "vertical"
 * @returns Array of cell coordinates a ship should occupy from the initial coordinates.
 */
